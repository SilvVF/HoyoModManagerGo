...
export namespace core {
	...
	export class KeyBind {
	    ...
	    constructor(source: any = {}) {
	        ...
	        this.sectionKey = source["sectionKey"];
	        this.key = source["key"];
	    }
	}
...
export namespace main {
	...
	export class CompressProgress {
	    ...
	    static createFrom(source: any = {}) {
	        return new CompressProgress(source);
	    }
	...
	export class CompressionState {
	    ...
	    static createFrom(source: any = {}) {
	        return new CompressionState(source);
	    }
	
	    constructor(source: any = {}) {
	        if ('string' === typeof source) source = JSON.parse(source);
	        this.running = source["running"];
	        this.prog = this.convertValues(source["prog"], CompressProgress);
	    }
	...
	export class PluginsState {
	    ...
	    static createFrom(source: any = {}) {
	        return new PluginsState(source);
	    }
	
	    constructor(source: any = {}) {
	        if ('string' === typeof source) source = JSON.parse(source);
	        this.Started = source["Started"];
	        this.PluginState = this.convertValues(source["PluginState"], PluginState);
	    }
...
export namespace types {
	...
	export class AppUpdate {
	    ...
	    constructor(source: any = {}) {
	        ...
	        this.publishesAt = this.convertValues(source["publishesAt"], null);
	        this.createdAt = this.convertValues(source["createdAt"], null);
	        this.dlLink = source["dlLink"];
