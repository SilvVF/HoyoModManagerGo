...
export const GenshinApi: DataApi = {
  ...
  skinId: GApi.SkinId,
  characters: async () =>
    DB.queries.selectCharactersByGame(await GApi.GetGame()),
  charactersWithModsAndTags: async () =>
...
export const StarRailApi: DataApi = {
  ...
  skinId: SRApi.SkinId,
  characters: async () =>
    DB.queries.selectCharactersByGame(await SRApi.GetGame()),
  charactersWithModsAndTags: async () =>
    DB.queries.selectCharacterWithModsTagsAndTextures(
      await SRApi.GetGame(),
      "",
...
export const ZenlessApi: DataApi = {
  ...
  characters: async () =>
    DB.queries.selectCharactersByGame(await ZZZApi.GetGame()),
  charactersWithModsAndTags: async () =>
    DB.queries.selectCharacterWithModsTagsAndTextures(
      await ZZZApi.GetGame(),
      "",
      "",
      "",
    ),
...
export const WutheringWavesApi: DataApi = {
  ...
  characters: async () =>
    DB.queries.selectCharactersByGame(await WuWaApi.GetGame()),
  charactersWithModsAndTags: async () =>
    DB.queries.selectCharacterWithModsTagsAndTextures(
      await WuWaApi.GetGame(),
      "",
      "",
      "",
    ),
