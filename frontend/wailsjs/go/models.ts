export namespace api {
	...
	export class CategoryRecord {
	    ...
	    _aPreviewMedia?: any;
	    // Go type: struct { IDRow int "json:\"_idRow,omitempty\""; SName string "json:\"_sName,omitempty\""; BIsOnline bool "json:\"_bIsOnline,omitempty\""; BHasRipe bool "json:\"_bHasRipe,omitempty\""; SProfileURL string "json:\"_sProfileUrl,omitempty\""; SAvatarURL string "json:\"_sAvatarUrl,omitempty\""; SHdAvatarUrl string "json:\"_sHdAvatarUrl,omitempty\""; SUpicUrl string "json:\"_sUpicUrl,omitempty\""; SSubjectShaperCssCode interface {} "json:\"_sSubjectShaperCssCode,omitempty\"" }
	    _aSubmitter?: any;
