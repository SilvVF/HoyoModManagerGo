export namespace api {
	...
	export class CategoryRecord {
	    ...
	    _bHasFiles?: boolean;
	    _aTags?: string[];
	    // Go type: struct { AImages []struct { SType string "json:\"_sType,omitempty\""; SBaseURL string "json:\"_sBaseUrl,omitempty\""; SFile string "json:\"_sFile,omitempty,omitempty\""; SFile220 string "json:\"_sFile220,omitempty,omitempty\""; HFile220 int "json:\"_hFile220,omitempty,omitempty\""; WFile220 int "json:\"_wFile220,omitempty,omitempty\""; SFile530 string "json:\"_sFile530,omitempty,omitempty\""; HFile530 int "json:\"_hFile530,omitempty,omitempty\""; WFile530 int "json:\"_wFile530,omitempty,omitempty\""; SFile100 string "json:\"_sFile100,omitempty,omitempty\""; HFile100 int "json:\"_hFile100,omitempty,omitempty\""; WFile100 int "json:\"_wFile100,omitempty,omitempty\"" } "json:\"_aImages,omitempty\"" }
	    _aPreviewMedia?: any;
	    // Go type: struct { IDRow int "json:\"_idRow,omitempty\""; SName string "json:\"_sName,omitempty\""; BIsOnline bool "json:\"_bIsOnline,omitempty\""; BHasRipe bool "json:\"_bHasRipe,omitempty\""; SProfileURL string "json:\"_sProfileUrl,omitempty\""; SAvatarURL string "json:\"_sAvatarUrl,omitempty\"" }
	    _aSubmitter?: any;
