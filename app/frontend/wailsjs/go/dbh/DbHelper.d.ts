...
import {dbh} from '../models';

export function CreateCustomCharacter(arg1:string,arg2:string,arg3:string,arg4:types.Game):Promise<void>;
...
export function SelectIniEntryByModId(arg1:number):Promise<dbh.IniCacheEntry>;
